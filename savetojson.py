...
# Create a list to store the item information
items = []
# Iterate over each image file
for i, image_file in enumerate(image_files, start=1):
    ...
    print(f"Processed image {i}/{len(image_files)} ")
...
json_file_path = os.path.join(output_folder, "item_info.json")
...
print(f"Item information exported to: {json_file_path}")
